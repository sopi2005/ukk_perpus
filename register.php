                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $level = $_POST['level'];
                                            $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,no_telp,level)
                                        ...
                                        <form method= "post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="inputpasword" type="text" name="password" placeholder="Masukan Password" />
                                            </div>
                                            <br>
                                            <div class="form-group">
